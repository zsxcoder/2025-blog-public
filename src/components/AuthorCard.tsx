...
export default function AuthorCard({ className = '', title, showLicense = false, summary = '' }: AuthorCardProps) {
        ...
        <div className="relative w-full flex flex-col md:flex-row items-stretch gap-0 bg-gradient-to-r from-white to-slate-50">
            ...
            <div className="relative md:w-64 shrink-0 bg-[#f9fafb]/80 flex flex-col items-center justify-between pt-8 px-8 pb-4 border-b md:border-b-0 md:border-r border-[#d3bc8e]/20 z-10 group/pisces">
                ...
                <div className="flex flex-col items-center w-full z-10 pt-4">
                    ...
                    <div className="w-24 h-24 rounded-full border-2 border-[#d3bc8e] p-1 bg-white/50 relative">
                        <img
                        ...
                        />
                        {/* Level Badge */}
                        <div className="absolute -bottom-1 -right-1 bg-[#d3bc8e] text-[#2b2f3a] text-[10px] font-bold px-2 py-0.5 rounded-full border-2 border-white">
                            Lv.{age}
                        </div>
                    </div>
                </div>

                    <h3 className="text-xl font-bold text-slate-800 font-sans tracking-wider mt-4">
                        {AUTHOR_PROFILE.name}
                    </h3>
